...
```
    ...
    --------------------------------------------------------------------------------
    Welcome to germinationmetrics version 0.1.10.9000
...
The current version of the package is 0.1.10. The previous versions are
as follows.
...
```
    ...
    1  6.632252 1.098973 #1. success  1.615220 7.105427e-14 -25.49868 56.99736
    ...
    7  6.622417 1.098272 #1. success  1.663019 7.815970e-14 -25.90697 57.81395
    ...
    12 6.718639 1.099892 #1. success  2.878146 9.663381e-13 -33.58613 73.17227
    ...
    15 6.732266 1.099760 #1. success  1.954008 5.400125e-13 -28.16444 62.32888
...
## Citing `germinationmetrics`
    ...
    To cite the R package 'germinationmetrics' in publications use:
      ...
      Indices and Curve Fitting. R package version 0.1.10.9000,
    ...
    A BibTeX entry for LaTeX users is
      ...
      @Manual{,
        ...
        note = {R package version 0.1.10.9000 https://aravind-j.github.io/germinationmetrics/ https://CRAN.R-project.org/package=germinationmetrics},
        year = {2026},
      }
...
```
    ...
    [1] germinationmetrics_0.1.10.9000 ggplot2_4.0.3                 
    ...
    [13] jsonlite_2.0.0      Matrix_1.7-5        ggrepel_0.9.8      
    ...
    [31] otel_0.2.0          tools_4.6.0         reshape2_1.4.5     
    [34] dplyr_1.2.1         mathjaxr_2.0-0      broom_1.0.12       
    [37] curl_7.1.0          vctrs_0.7.3         R6_2.6.1           
    [40] stats4_4.6.0        lifecycle_1.0.5     gslnls_1.4.2       
    ...
    [52] gtable_0.3.6        data.table_1.18.2.1 glue_1.8.1         
