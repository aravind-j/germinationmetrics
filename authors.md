...
- **S. Vimala Devi**. Author.

- **J. Radhamani**. Author.

- **Sherry Rachel Jacob**. Author.
...
Source:
[`inst/CITATION`](https://github.com/aravind-j/germinationmetrics/blob/master/inst/CITATION)
...
Fitting. R package version 0.1.10.9000,
