...
#' \insertCite{reddy_effect_1978}{germinationmetrics}.
#'
#'
...
#' WeightGermPercent(germ.counts = x, total.seeds = 50)
#'
#' # From cumulative germination counts
#' WeightGermPercent(germ.counts = y, total.seeds = 50, partial = FALSE)
#'
#'
